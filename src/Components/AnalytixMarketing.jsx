    ...
    <div className="w-full flex flex-col pt-16 items-center justify-center px-1">
      ...
      <div className="flex justify-center items-center px-4 sm:px-6 lg:px-8">
        <p className="text-center text-sm sm:text-base lg:text-lg md:py-7 tracking-wide">
          We can understand the consumers better than ever before with Analytix
          Marketing. It is a methodology <br />
          of collecting user information like the purchases they make, the
          social media profiles they visit, the articles <br /> they read, the
          sites they spend more time on, etc. From these collected data, we can
          get a clear picture of <br /> the hidden patterns about their
          behaviors. It actually reveals the deepest desires and needs of our{" "}
          <br />
          target audience. Since every action leaves a digital footprint,
          Analytix Marketing helps predict the next big trend before it <br />{" "}
          even emerges. It transforms raw data into actionable insights, and the
          most powerful aspect of it is the <br />
          ability to personalize the customer experience. auxzon will let you
          create highly targeted campaigns that <br /> resonate with individual
          customers on a deeply personal level. auxzon also gets the assistance
          of <br /> advanced analytics techniques such as machine learning and
          artificial intelligence to extract meaningful <br /> patterns from the
          noise.
        </p>
      </div>

        ...
        <div className="w-full flex flex-col pt-16 items-center justify-center px-1">
          ...
          <div className="flex justify-center items-center px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm sm:text-base lg:text-lg md:py-3 tracking-wide">
              We develop strategies for organizations to help them implement
              that align with their long-term goals <br /> and objectives. Our
              expert consultants work closely with businesses to assess their
              current position,
          ...
          <div className="w-full flex flex-col pt-2 items-center justify-center px-1">
            ...
            <p className="text-center text-sm sm:text-base lg:text-lg md:py-3 tracking-wide">
              ...
              <br />
              them is the only way to grow. Here is where auxzon can help you
              with our Risk Assessment Solutions <br /> and Tools. We have
              exceptionally skilled professionals to handle Regulatory
              Compliance services and <br />
              Fraud Detection Systems. It helps predict future outcomes and
              develop strategies accordingly to reduce <br />
              risk.
            </p>
          </div>
          {/* ---------------------------- */}

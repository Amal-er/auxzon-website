        ...
        <div className="w-full flex flex-col pt-16 items-center justify-center px-1">
          ...
          <div className="flex justify-center items-center px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm sm:text-base lg:text-lg md:py-3 tracking-wide">
              ...
              software applications to address <br /> specific business needs
              and requirements. It will be built from the ground up to meet the
              unique <br />
              challenges and objectives. Beginning with a comprehensive analysis
              of the client's requirements,
              <br /> workflows, and goals, auxzon's Custom Development of Data
              Applications and Integration Services will <br /> empower
              businesses.
            </p>
          </div>
          ...
          <div className="w-full flex flex-col pt-2 items-center justify-center px-1">
            ...
            <p className="text-center text-sm sm:text-base lg:text-lg md:py-3 tracking-wide">
              ...
              auxzon has special expertise, creativity, and strategic thinking
              in conceptualizing, designing, <br /> developing, testing, and
              deploying Custom or Responsive Websites and Mobile Apps (iOS and
              Android).
            </p>
          </div>
          {/* ---------------------------- */}
